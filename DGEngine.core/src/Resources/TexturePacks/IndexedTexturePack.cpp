...
sf::Vector2i IndexedTexturePack::getTextureSize(uint32_t index) const
{
	if (translateIndex(index) == true)
	{
...
void IndexedTexturePack::addAnimatedTexture(uint32_t animIndex, sf::Time refresh, const std::vector<uint32_t>& indexes)
{
