...
namespace SaveUtils
{
	...
	void writeVector2Number(rapidjson::PrettyWriter<rapidjson::StringBuffer>& writer, const T& val)
	{
		writer.StartArray();
		...
		const std::string_view key, const T& val)
	{
		...
		writeVector2Number<T, NumType>(writer, val);
	}
	...
	// same line formatted.
	template <class T>
	void writeVector2i(rapidjson::PrettyWriter<rapidjson::StringBuffer>& writer, const T& val)
	{
		writeVector2Number<T, decltype(val.x)>(writer, val);
	}

	// same line formatted.
	template <class T>
	void writeVector2f(rapidjson::PrettyWriter<rapidjson::StringBuffer>& writer, const T& val)
	{
		writeVector2Number<T, decltype(val.x)>(writer, val);
	}
	...
	// same line formatted.
	template <class T>
	void writeVector2fi(rapidjson::PrettyWriter<rapidjson::StringBuffer>& writer, const T& val)
	{
		writer.StartArray();
		writer.SetFormatOptions(rapidjson::PrettyFormatOptions::kFormatSingleLineArray);
