...
public:
	...
	auto operator[] (size_t x) const noexcept { return Misc::Helper2D<const Vector2D, const T&, size_t>(*this, x, get); }
	...
	void set(size_t x, size_t y, T val) { set(x + y * width, val); }

	auto Width() const noexcept { return width; }
	auto Height() const noexcept { return height; }
};
