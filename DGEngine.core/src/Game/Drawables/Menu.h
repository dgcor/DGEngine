...
class Menu : public ActionQueryable, public UIObject
{
private:
	...
	bool recalculatePositions{ false };
	bool recalculateVisibleItems{ true };
	size_t start{ 0 };
	size_t end{ 0 };
...
public:
	...
	void addItem(const std::shared_ptr<StringButton>& item, bool recalculatePositions_);
