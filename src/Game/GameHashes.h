...
namespace ItemProp
{
	...
	const uint16_t Capacity = str2int16("capacity");
	const uint16_t Quantity = str2int16("quantity");
	...
	const uint16_t ResistFire = str2int16("resistFire");
	...
	const uint16_t Charges = str2int16("charges");
	const uint16_t ChargesMax = str2int16("chargesMax");

	const uint16_t RequiredStrength = str2int16("requiredStrength");
